...
def maybe_use_termcolor(message: str, color: str | None = None, **kwargs: Any) -> str:
    """
...
def green(message: str, light: bool = True) -> str:
    """
...
def red(message: str, light: bool = True) -> str:
    """
...
def yellow(message: str, light: bool = True) -> str:
    """
...
def blue(message: str, light: bool = True) -> str:
    """
...
def cyan(message: str, light: bool = True) -> str:
    """
...
def magenta(message: str, light: bool = True) -> str:
    """
